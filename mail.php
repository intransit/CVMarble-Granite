 ...
 case "send":
    ...
    if (!preg_match("/^[0-9 #\-\*\.\(\)]+$/",$fphone1))
    {
      ...
      break;
       ...
       $myemail = "ravi.shankar@patharitech.com";
       ...
       $ehead = "From: ".$femail."\r\n";
	   $ehead = "mailed-by: patharitech.com"."\r\n";
...
<html>
<body>
<form action="mail.php?do=send" method="POST">
<p>* Required fields</p>
<?php
...
<p>
   <table border="0" width="500">
     <tr><td align="right">* Street Address: </td>
         <td><input type="text" name="saddy" size="50" value="<?php echo @$saddy ?>"></td></tr>
...
<p>
   <table border="0" width="350">
     ...
     <tr><td align="right">Phone Number 3: </td>
         <td><input type="text" name="fphone3" size="20" value="<?php echo @$fphone3 ?>"></td></tr>
   </table>
<p>
   <table border="0" width="400"><tr><td>
     Comments:<br />
     <TEXTAREA name="fsendmail" ROWS="6" COLS="40"><?php if($fsendmail) echo $fsendmail; ?></TEXTAREA>
     </td></tr>

 ...
 case "freequote":
	  ...
	  $imgloc = $params->imgloc;
	   ...
	   $femail ="info@cvmarbleandgranite.com";
		...
		$emessage = "<html><head></head><body>";
		$emessage .="Customer Name:".$name."<br>";
		$emessage .="Customer Email:".$email."<br>";
		$emessage .="Material Id:".$material;
		$emessage .= "<img src='http://cvmarbleandgranite.patharitech.com/".$imgloc."' alt='' width='200px' height='100px' /></body></html>";
       ...
       $ehead = "From: ".$femail."\r\n";
	   $ehead .= "Content-type: text/html";
	   
       $subj = "Quote required by ".$name."!";
       $mailsend=mail("$myemail","$subj","$emessage","$ehead");
       $message = $mailsend;
